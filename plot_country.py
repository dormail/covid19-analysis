...
def plot_one(country,data):
    ...
    # the change plot is to wavey to see some real change, splitting up in weeks
    #weeks = math.floor(len(inf_change)/7)
    #last_week_days = len(inf_change) % 7
    #if (last_week_days):
        #weeks = weeks + 1
